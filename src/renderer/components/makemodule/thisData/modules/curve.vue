<template>
    <div id="curveBox">
        <table ref="myt" class="columnName" border="1" cellspacing="0">
            ...
            <tr v-for="(item, index) in solutionPreparationData.biaoZhunArr" :key="index">
                <td width="110">
                    <selectModel :list="solutionPreparationData.materialList"
                                 @returnVal="returnVal"
                                 :Judge="true"
        ...
        <table>
            <tr class="temperature">
                ...
                <td width="86">
                    <div class="temperatureValue">
                        <divModel v-model="solutionPreparationData.solutionTemperature"></divModel>
                    </div>
                </td>
        ...
        <div>
            <table class="checkTable" border="1">
                ...
                <tr>
                    <td style="width: 100px;">
                        <input index="0" type="checkbox" class="inp" name="category"
                               :checked="isSelected(0)" value="电子天平"/> 电子天平：
                    </td>
                    ...
                    <td>
                        <divModel v-model="solutionPreparationData.biaoHaoArr[0]"></divModel>
                    </td>
                </tr>
                <tr>
                    <td ><input index="1" type="checkbox" class="inp" name="category"
                    ...
                    <td>编号:</td>
                    <td>
                        <divModel v-model="solutionPreparationData.biaoHaoArr[1]"></divModel>
                    </td>
                </tr>
                <tr>
                    <td ><input index="2" type="checkbox" class="inp" name="category"
                    ...
                    <td>编号:</td>
                    <td>
                        <divModel v-model="solutionPreparationData.biaoHaoArr[2]"></divModel>
                    </td>
                </tr>
                <tr>
                    <td ><input index="3" type="checkbox" class="inp" name="category"
                    ...
                    <td>编号:</td>
                    <td>
                        <divModel v-model="solutionPreparationData.biaoHaoArr[3]"></divModel>
                    </td>
                </tr>
                <tr>
                    <td ><input index="4" type="checkbox" class="inp" name="category"
                    ...
                    <td>编号:</td>
                    <td>
                        <divModel v-model="solutionPreparationData.biaoHaoArr[4]"></divModel>
                    </td>
                </tr>
                <tr>
                    <td ><input index="5" type="checkbox" class="inp" name="category"
                    ...
                    <td>编号:</td>
                    <td>
                        <divModel v-model="solutionPreparationData.biaoHaoArr[5]"></divModel>
                    </td>
                </tr>
                <tr>
                    <td ><input index="6" type="checkbox" class="inp" name="category"
                    ...
                    <td>编号:</td>
                    <td>
                        <divModel v-model="solutionPreparationData.biaoHaoArr[6]"></divModel>
                    </td>
                </tr>
            </table>
            <table class="checkTable" border="1">
            ...
            <table class="biaoZhunTable">
                ...
                <tr v-for="(item, index) in solutionPreparationData.biaoZhunDownArr" :key="index">
                    <td>
                        <divModel :edit="!item.materiaId" v-model="item.materialName" ></divModel>
                    </td>
                    <td>
        ...
        <div v-if="solutionPreparationData.biaoZhunArr.length <= 0" class="rowOption addRow" @dblclick="addRow(0)">+
        </div>           <!-- 提高一行 -->
        <div v-if="solutionPreparationData.biaoZhunArr.length <= 0" class="rowOption delRow" @dblclick="delRow(0)">-
        </div>
        <div v-if="solutionPreparationData.biaoZhunDownArr.length <= 0" class="rowOption addRowDown"
             @dblclick="addRowDown(0)">+
        </div>           <!-- 提高一行 -->
        <div v-if="solutionPreparationData.biaoZhunDownArr.length <= 0" class="rowOption delRowDown"
        ...
        methods: {
            ...
            delRowDwon(index) {
                if (this.solutionPreparationData.biaoZhunDownArr.length > 0) {
                    let deleteMateriaId = this.solutionPreparationData.biaoZhunDownArr[index].materiaId;
                    let result = this.solutionPreparationData.biaoZhunArr.findIndex(item => item.id == deleteMateriaId);
                    if(result == -1){
            ...
            returnVal(showText, index, special, selectedObj) {
                ...
                if(biaoZhunDown){
                    ...
                    this.solutionPreparationData.biaoZhunDownArr.splice(index + 1, 0, {materialName: selectedObj.materialName, materiaId: selectedObj.id});
                }
            }
        },
        mounted: function () {
