  ...
  <div class="___relative">
    ...
    <table class="myTable">
      ...
      <tr v-for="item in data.valueData.point" :key="item.pointId">
        ...
        <td>
          <!-- <myInput :reg="'[^0-9/]'" @change.native="report(item)" v-model="item.volume"></myInput> -->
          <span>{{ item.exposureTime }}</span>
        </td>
        <td>
