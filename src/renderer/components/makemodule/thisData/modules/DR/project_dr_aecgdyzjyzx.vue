            ...
            <div style="text-align: center;">
                ...
                <div style="border: 1px solid black; border-top: none; padding: 5px;">
                    ...
                    <el-radio label="是"
                              ...
                              @click.native.prevent="computeObj.clearRadio('是', data.valueData.arr, 0)"
                              style="width: 20px; margin-left: 10px;"></el-radio>
                    <el-radio label="否" v-model="data.valueData.arr[0]"
                              @click.native.prevent="computeObj.clearRadio('否', data.valueData.arr, 0)"
                              style="width: 20px;"></el-radio>，SID= <myInput style="width: 60px; border-bottom: 1px solid black; padding: 0" v-model="data.valueData.arr[1]"></myInput>cm，
                    器官曝光程序<myInput style="width: 60px; border-bottom: 1px solid black; padding: 0" v-model="data.valueData.arr[2]"></myInput>，附加滤过<myInput style="width: 60px; border-bottom: 1px solid black; padding: 0" v-model="data.valueData.arr[3]"></myInput>。
                </div>
            </div>
            <table class="myTable">
                <tr class="delLine">
                ...
                <tr>
                    <td style="text-align: left; padding: 20px;">
                        <p>
                            <el-radio
                                    ...
                                    @click.native.prevent="computeObj.clearRadio('剂量值/μGy', data.valueData.point[0], 'v1')"
                                    label="剂量值/μGy"></el-radio>
                        </p>
                        <p>
                            <el-radio v-model="data.valueData.point[0].v1"
                                      @click.native.prevent="computeObj.clearRadio('DDI值', data.valueData.point[0], 'v1')"
                                      label="DDI值"></el-radio>
                        </p>
                    </td>
                    <td>
                    ...
                    <td style="text-align: left; padding-left: 10px;">
                        <p>
                            <el-radio v-model="data.valueData.point[0].v7"
                                      @click.native.prevent="computeObj.clearRadio('建立基线值', data.valueData.point[0], 'v7')"
                                      label="建立基线值"></el-radio>
                        </p>
                        <p>
                            <el-radio v-model="data.valueData.point[0].v7"
                                      @click.native.prevent="computeObj.clearRadio('基线值=', data.valueData.point[0], 'v7')"
                                      label="基线值="
                                      style="width: 50px;"></el-radio>
                            <myInput v-if="data.valueData.point[0].v7 === '基线值='"
