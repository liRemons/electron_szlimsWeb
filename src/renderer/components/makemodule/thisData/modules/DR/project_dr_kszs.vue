  ...
  <div style="line-height: 30px; padding-top: 10px;" class="___relative">
    ...
    <div>
      <div style="text-align: center;">
        ...
        <div
          style="border: 1px solid black; border-top: none; line-height: 20px;"
          class="tl"
        >
        ...
        <table class="myTable">
          ...
          <tr>
            <td style="width: 150px;">
              ...
              <div style="text-align: left; padding-left: 20px;">
                <el-radio
                  v-model="data.valueData.factoryValue"
                  @click.native.prevent="
                    computeObj.clearRadio('有', data.valueData, 'factoryValue')
                  "
                  label="有"
                  style="width: 20px;"
                ></el-radio>
                <el-radio
                  v-model="data.valueData.factoryValue"
                  @click.native.prevent="
                    computeObj.clearRadio('无', data.valueData, 'factoryValue')
                  "
                  label="无"
                  style="width: 20px;"
                ></el-radio>
          ...
          <tr>
            <td>
              <el-radio
                v-model="data.valueData.hasShadow"
                @click.native.prevent="
                  computeObj.clearRadio('是', data.valueData, 'hasShadow')
                "
                label="是"
                style="width: 30px;"
              ></el-radio>
              <el-radio
                v-model="data.valueData.hasShadow"
                @click.native.prevent="
                  computeObj.clearRadio('否', data.valueData, 'hasShadow')
                "
                label="否"
              ></el-radio>
            </td>
            ...
            <td>
              <div
                style="height: 100px; line-height: 24px; text-align: left; padding-left: 20px;"
              >
                <p>
                  <el-checkbox v-model="data.valueData.checkBoxArr[0]" disabled
                    >在厂家规定值内</el-checkbox
                  >
                </p>
                <p>
                  <el-checkbox v-model="data.valueData.checkBoxArr[1]" disabled
                    >在厂家规定值外</el-checkbox
                  >
                </p>
                <p>
                  <el-checkbox v-model="data.valueData.checkBoxArr[2]" disabled
                    >建立基线值 =
                    <span
                      v-if="data.valueData.checkBoxArr[2]"
                      style="border-bottom: 1px solid black; padding-left: 10px; padding-right: 10px;"
                      >{{ data.valueData.arr[2] }}</span
                    >
                  </el-checkbox>
                </p>
                <p>
                  <el-checkbox v-model="data.valueData.checkBoxArr[3]" disabled
                    >与基线值的偏差=<span
                      v-if="data.valueData.checkBoxArr[3]"
                      >{{ data.valueData.eValue }}</span
                    >%</el-checkbox
                  >
                </p>
              </div>
...
export default {
  ...
  methods: {
    ...
    checkValue(el) {
      ...
      this.$forceUpdate();
      this.changeValue(this.testPurpose);
      this.setEValue();
    },
