<template>
  <div style="line-height: 30px; padding-top: 10px;" class="___relative">
    ...
    <div>
      ...
      <table class="myTable">
        <tr class="delLine" style="line-height:16px">
          <td>SID/cm</td>
          <td>滤线栅<br />是否取出</td>
          <td>是否有<br />床面衰减</td>
          <td>器官曝光<br />程序</td>
          ...
          <td>检测指标</td>
          <td>检测结果</td>
          <td style="text-align: left; padding-left: 5px; width: 60px;">
            <p v-if="state === '状态检测'">
              <el-radio
        ...
        <tr>
          ...
          <td>
            <selectModel
              ...
              :multi-select="false"
              :receive="'AECNum'"
              :transmitText="data.valueData.arr2[6]"
              :single="true"
              :rows="false"
              :list="['是', '否']"
              :Obj="''"
          ...
          <td><myInput v-model="data.valueData.arr2[7]"></myInput></td>
          <td><myInput v-model="data.valueData.arr2[8]"></myInput></td>
          <td><myInput v-model="data.valueData.arr2[9]"></myInput></td>
