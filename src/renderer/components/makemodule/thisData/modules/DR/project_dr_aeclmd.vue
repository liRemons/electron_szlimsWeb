    ...
    <div style="line-height: 30px; padding-top: 10px;" class="___relative">
        ...
        <div>
            <div style="text-align: center;">
                ...
                <div class="tl" style="border: 1px solid black;font-weight: bolder; border-top: none; line-height: 20px;">
                    标准要求
                </div>
            ...
            <table class="myTable">
                <tr class="delLine">
                    ...
                    <td style="text-align: left; padding-left: 5px; width: 105px;">
                        <p v-if="state === '状态检测'">
                            <el-radio v-model="data.valueData.radioVal"
                                      @click.native.prevent="computeObj.clearRadio('基线值', data.valueData, 'radioVal')"
                                      label="基线值"></el-radio>
                        </p>
                        <p>
                            <el-radio v-model="data.valueData.radioVal"
                                      @click.native.prevent="computeObj.clearRadio('建立基线值', data.valueData, 'radioVal')"
                ...
                <tr>
                    ...
                    <td style="text-align: left; padding-left: 5px;">
                        <p>
                            <el-radio v-model="data.valueData.baseValue"
                                      @click.native.prevent="computeObj.clearRadio('mA、s', data.valueData, 'baseValue')"
                                      label="mA、s"></el-radio>
                        </p>
                        <p>
                            <el-radio v-model="data.valueData.baseValue"
                                      @click.native.prevent="computeObj.clearRadio('mAs', data.valueData, 'baseValue')"
                                      label="mAs"></el-radio>
                        </p>
                        <p>

                            <el-radio v-model="data.valueData.baseValue"
                                      @click.native.prevent="computeObj.clearRadio('DDI值', data.valueData, 'baseValue')"
                                      label="DDI值"></el-radio>
                        </p>
                    </td>
                    <td>
                        <myInput v-model="data.valueData.arr2[3]" @keyup.native="(el) => {setEValue(el, 0)}"></myInput>
                    </td>
                    <td>
                        <myInput v-model="data.valueData.arr2[4]" @keyup.native="(el) => {setEValue(el, 1)}"></myInput>
                    </td>
                    <td>
            ...
            <div style="border: 1px solid black;border-top: none; text-align: left; padding-left: 200px;">
                <div>
                    <p>
        ...
        methods: {
            ...
            sure(){
                if(this.data.valueData.baseValue === ""){
                    ...
                    if(this.state === "状态检测" && this.data.valueData.radioVal === '建立基线值' && this.data.valueData.note === ""){
                        this.$notify({
                            type: 'warning',
                            message: '备注必须二选一'
                        });
