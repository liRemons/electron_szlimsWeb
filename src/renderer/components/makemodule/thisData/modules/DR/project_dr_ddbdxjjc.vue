        ...
        <div>
            <div style="text-align: center;">
                ...
                <div style="border: 1px solid black; border-top: none; padding: 4px;">
                    <div class="___relative">
                        <div class="___absolute" style="left: 6px; width: 80px; text-align: left;">
                            使用的模体：
                        </div>
            ...
            <table class="myTable">
                ...
                <tr>
                    ...
                    <td>细节数</td>
                    <td>
                        <myInput v-model="data.valueData.point[0].v1" v-if="result"></myInput>
                        <div v-else>/</div>
                    </td>
                    <td>
                        <myInput v-model="data.valueData.point[0].v2" v-if="result"></myInput>
                        <div v-else>/</div>
                    </td>
                    <td>
                        <myInput v-model="data.valueData.point[0].v3" v-if="result"></myInput>
                        <div v-else>/</div>
                    </td>
                </tr>
                <tr>
                    <td>对比度</td>
                    <td>
                        <myInput v-model="data.valueData.point[1].v1" v-if="result"></myInput>
                        <div v-else>/</div>
                    </td>
                    <td>
                        <myInput v-model="data.valueData.point[1].v2" v-if="result"></myInput>
                        <div v-else>/</div>
                    </td>
                    <td>
                        <myInput v-model="data.valueData.point[1].v3" v-if="result"></myInput>
                        <div v-else>/</div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <myInput v-model="data.valueData.point[4].v1" v-if="data.valueData.checkboxsValue[1] && state === '状态检测'"></myInput>
                        <div v-else>{{data.valueData.point[4].v1}}</div>
                    </td>
                    <td>
                        <myInput v-model="data.valueData.point[4].v2" v-if="data.valueData.checkboxsValue[1] && state === '状态检测'"></myInput>
                        <div v-else>{{data.valueData.point[4].v2}}</div>
                    </td>
                    <td>
                        <myInput v-model="data.valueData.point[4].v3" v-if="data.valueData.checkboxsValue[1] && state === '状态检测'"></myInput>
            ...
            <div style="border: 1px solid black;border-top: none; text-align: left;">
                <p style="margin-left: 200px;">
                    <el-checkbox v-model="data.valueData.note[0]" @change="changeNote" :disabled="state === '验收检测'">新标准实施后首次检测，建立基线值。
                    </el-checkbox>
                </p>
                <p style="margin-left: 200px;">
                    <el-checkbox v-model="data.valueData.note[1]" @change="changeNote" :disabled="state === '验收检测'">无法确认建立基线值的检测条件，建立基线值。
                    </el-checkbox>
                </p>
            </div>
    ...
    export default {
        ...
        watch:{
            "data.valueData.point": {
                ...
                handler: function (point) {
                    let item = point[3];
                    if(!this.data.valueData.checkboxsValue[1] && this.state === '状态检测'){
        ...
        methods: {
            ...
            sure(){
                ...
                if(this.state === '状态检测' && this.data.valueData.note.every(item => item === false)){
                    let result = true;
                    for(let i = 0; i < 4; i++){
