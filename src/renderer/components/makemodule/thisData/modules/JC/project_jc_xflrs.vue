            ...
            <span>
              ...
              <br/>人数
				...
				<tr v-for="(item,index) in data.valueData.point">
					...
					<td class="___relative">
						...
						<div class="___relative tl" style="line-height: 16px;height: 16px;">
							<div v-if="item.shape==='矩形'" class="___relative">
								...
								<myInput
												class="___relative"
												style="width:45px;text-align: center;height: 16px;top:1px;"
							...
							<div v-if="item.shape==='圆形'" class="___relative">
								...
								<myInput
												class="___relative"
												style="width:80px;text-align: center;height: 16px;top:1px;"
												v-model="item.formula[0]"
												@change.native="getMeasureArea(index)"
												:defaultValue="item.formula[0]"
								></myInput>
					...
					<td class="___relative">
						<div class="___relative" v-for="(val,num) in 4" :class="val!==4 ? 'borderBottom':''">
							<div
											v-for="(v,i) in 4"
							...
							>
								...
								<div class="___absolute t0" style="width:56px;left:30px;line-height: 16px;">
									<myInput
    ...
    methods: {
      getIdPoint(keyArr, id) {
        this.jsonString.forEach((item, index) => {
          if (item.data.name === "project_jc_xflrs" && this.data.valueData.multipleId === item.data.valueData.multipleId) {
