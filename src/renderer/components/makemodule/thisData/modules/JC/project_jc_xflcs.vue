              ...
              <br/>体积
				...
				<tr v-for="(item,index) in data.valueData.point">
					...
					<td class="___relative tc">
						...
						<div class="___absolute toolBar" style="left: 417px;top:0; width: 62px;" v-if="target ==0">
    ...
    methods: {
      ...
      getIdPoint(keyArr, id) {
        this.jsonString.forEach((item, index) => {
          if (item.data.name === "project_jc_xflcs" && this.data.valueData.multipleId === item.data.valueData.multipleId) {
      ...
      addRow(index, Judge, heBingId) {
        ...
        if (Judge === 1) {
          ...
          let id =
                  "project_jc_xflcs-" + this.pageNumber + "-" + this.thisPageIndex;
