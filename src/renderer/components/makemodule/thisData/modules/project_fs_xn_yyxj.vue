<template>
    <div class="___relative" style="padding-top: 20px;">
        ...
        <table border="1" class="myTableReset _normalHeight_">
            <tr>
                <th align="left" colspan="2" class="p20">{{data.valueData.testProjectChineseName}}</th>
            </tr>
            <tr>
                <th class="p20 tc" colspan="2">标准要求</th>
            </tr>
            <tr>
                <td class="p20 tl" colspan="2" style="line-height:16px;">
            ...
            <tr v-for="(item,index) in data.valueData.point">
                ...
                <td class="___relative">
                    <divModel v-model="item.rows[1]" style="width:100%;text-align: center;"
                              class="moduleInput hide focusBg"></divModel>
                    <div class="__functionBox"
                         v-if="index!=data.valueData.point.length-1&&ipdTemplate=='ipdTemplate' &&data.valueData.point.length>1 && target == 0"
        ...
        <div class="__functionBox" v-if="ipdTemplate=='ipdTemplate' && target == 0">
