<template>
    <div class="___relative" style="padding-top: 20px;">
        ...
        <table border="1" class="myTableReset _normalHeight_">
            <tr>
                <th align="left" colspan="6" class="p20">{{data.valueData.testProjectChineseName}}</th>
            </tr>
            <tr>
            ...
            <tr>
                <td class="___relative" colspan="6" align="center">
                    <span>检测条件：管电压：</span>
                    <div class="___absolute t0" style="width:70px;height:36px;left:270px;">
                        <divModel v-model="data.valueData.tubeVoltage" style="width:50px;text-align: center; border-bottom: 1px solid black; height: 28px;"
                                  class="Full moduleInput hide focusBg"></divModel>
                        <span class="___absolute right0">kV</span>
                    </div>
                    <span style="margin-left: 70px;">，管电流：</span>
                    <div class="___absolute t0" style="width:70px;height:32px;left:400px;">
                        <divModel v-model="data.valueData.tubeCurrent" style="width:50px;text-align: center; border-bottom: 1px solid black; height: 28px;"
                                  class="Full moduleInput hide focusBg"></divModel>
                        <span class="___absolute right0">mA</span>
                    </div>
                    <span style="margin-left: 70px;">，曝光时间：</span>
                    <div class="___absolute t0" style="width:70px;height:32px;left:550px;">
                        <divModel v-model="data.valueData.timeExposure" style="width:50px;text-align: center; border-bottom: 1px solid black; height: 28px;"
                                  class="Full moduleInput hide focusBg"></divModel>
            ...
            <tr v-for="(item,index) in data.valueData.point">
                ...
                <td class="___relative">
                    <divModel v-model="item.rows[5]"
                              ...
                              :edit="false"
                              :is-computer="true"
                              :computers="changeNum(item.rows[0],item.rows[1],item.rows[2],item.rows[3],item.rows[4],index)"
        ...
        methods: {
            ...
            changeNum(num1, num2, num3, num4, num5, index) {
                ...
                if (calculation.length == 5) {
                    ...
                    this.data.valueData.point[index].rows[5]=((Math.sqrt(total/4)/average)*100).toFixed(1)
                }
            },
        },
        components: {},
