  ...
  <div :class="{ _normalHeight_: true }" class="___relative">
    ...
    <div class="modules_1_tableBox ___relative mt10">
      <p style="line-height: 16px; margin-top: 10px;">
        4.1 透视受检者入射体表空气比释动能率典型值/（mGy/min）
      </p>
      ...
      <p style="line-height: 16px; margin-top: 10px;">4.1.2 检测及计算方法</p>
      <div
        class="___relative ___module_frame_Box"
        style="border-top: solid 1px black;"
      >
        <div
          ...
          style="line-height: 16px; padding-left: 5px;"
        >
          <span
            >将尺寸为30cm×30cm×20cm的水模放置在探测器与影像接收器之间，调节至影像接收器最大照射野尺寸下进行检测，检条<br />件见下表：</span
          >
        </div>
        <div class="___relative borderBottom">
          <div style="width: 140px;" class="tc borderRight ___relative">
            <span>X射线透视设备类型</span>
          </div>
          <div
            style="width: 170px; left: 140px;"
            class="___absolute t0 tc borderRight"
          >
            <span>探测器位置</span>
          </div>
          <div
            style="width: 130px; left: 310px;"
            class="___absolute t0 tc borderRight"
          >
            <span>影像接收器位置</span>
          </div>
          <div
            style="width: 130px; line-height: 16px; left: 440px;"
            class="___absolute t0 tc borderRight"
          >
            <span>有AERC的透视<br />条件</span>
          </div>
          <div
            style="width: 140px; line-height: 16px;"
            class="___absolute t0 tc right0"
          >
            <span>无AERC<br />的透视条件</span>
          </div>
        </div>
        <div class="___relative borderBottom">
          <div
          ...
          <div
            style="width: 130px; left: 440px;"
            class="Full t0 tc borderRight"
          >
            <divModel
              v-model="data.valueData.thereAreAERC"
              style="width: 100%; text-align: center;"
              class="___absolute heightCenter3 hide focusBg"
            ></divModel>
          </div>
          <div style="width: 140px;" class="Full t0 tc right0">
            <div
              style="width: 140px; height: 32px;"
              class="tc borderRight borderBottom ___relative"
            >
              <divModel
                v-model="data.valueData.NoAERC[0]"
                style="width: 100%; text-align: center;"
                class="Full heightCenter3 hide focusBg"
              ></divModel>
            </div>
            ...
            >
              <divModel
                v-model="data.valueData.NoAERC[1]"
                style="width: 100%; text-align: center;"
                class="___absolute heightCenter3 hide focusBg"
              ></divModel>
            </div>
        ...
        <div class="___relative">
          <span class="ml5">计算公式：校准值=测量值×校准因子。</span>
        </div>
      </div>
      <p style="line-height: 16px; margin-top: 10px;">
        4.1.3 检测条件、仪器示值与检测结果
      </p>
      <div
        class="___relative ___module_frame_Box"
        style="border-top: solid 1px black;"
