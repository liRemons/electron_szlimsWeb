      ...
      <div class="modules_1_tableBox ___relative mt20">
        ...
        >
          ...
          <div class="___relative borderBottom">
            ...
            >
              <div
                style="line-height: 1rem;word-break: break-all;white-space: pre-wrap; font-size: 12px;"
              >
          ...
          <div class="___relative">
            ...
            <div style="width:621px;left:90px;" class="___relative">
              ...
              >
                <div
                  style="width: 120px;word-break: break-all;white-space: pre-wrap;"
...
export default {
  ...
  mounted() {
    ...
    this.$store.dispatch(
      "actionsDeviceFactor",
      JSON.stringify(this.data.valueData.point[0].deviceFactor)
    );
  }
};
</script>
