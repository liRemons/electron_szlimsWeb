				...
				<div class="___relative borderBottom">
					...
					<div class="___relative" style="width: 540px;left:170px;">
						<div class="___relative borderBottom" style="width: 540px;">
							<div class="___relative borderRight tc w100" style="width: 185px;">
								<span>设备状态</span>
							</div>
							<div class="___absolute tc t0 Full" style="width: 355px;left:185px;">
								<div style="width:100%;text-align: center;"
										 class="Full warp2 rowsInput2 hide focusBg">{{data.valueData.deviceState}}
								</div>
							</div>
						</div>
						<div class="___relative borderBottom" style="width: 540px;">
							...
							<div class="___absolute tc t0 Full" style="width: 355px;left:185px;">
								<div style="width:100%;text-align: center;"
										 class="Full warp2 rowsInput2 hide focusBg">{{data.valueData.exposureMode}}
								</div>
							</div>
						</div>
						<div class="___relative borderBottom" style="width: 540px;">
							...
							<div class="___absolute tc t0 Full" style="width: 355px;left:185px;">
								<div style="width:100%;text-align: center;"
										 class="Full warp2 rowsInput2 hide focusBg">{{data.valueData.harnessDirection}}
								</div>
							</div>
						</div>
						<div class="___relative borderBottom" style="width: 540px;">
							<div class="___absolute Full borderRight tc w100" style="width: 185px;">
							...
							<div class="___relative" style="width: 355px;left:185px;">
								<div class="___relative">&nbsp;
									<div class="inputBlock ___absolute Full" style="width: 80px;">
										<divModel v-model="data.valueData.exposureParameterkV1"
									...
									<div class="___absolute Full" style="width: 100px;left:80px;">
										<divModel v-model="data.valueData.exposureParametermA"
									...
									<div class="___absolute Full" style="width: 120px;left:190px;">
										<myInput style="width: 50px; border-bottom: 1px solid black; height: 30px;" class="___absolute"
														 v-model="data.valueData.exposureParameterms" v-if="data.valueData.unit2 != '/'"></myInput>
										<div v-else style="width:70px;text-align: center;" class="Full warp2 rowsInput2 hide focusBg"></div>
										<selectModel @returnVal="returnVal"
																 :Judge="true"
																 :multi-select="false"
								...
								<div class="___relative">
									<el-radio v-model="data.valueData.exposureParameterState" style="margin-left:10px;"
														label="自动"></el-radio>
						...
						<div class="___relative" style="width: 540px;">
							...
							<div class="___absolute t0 Full" style="width: 355px;left:185px; ">
								...
								<div v-if="data.valueData.radio==='1'">
									<div class="inputBlock ___absolute Full" style="width: 80px;padding-left: 5px;left:130px;">
										<divModel v-model="data.valueData.irradiationField1"
															style="width:50px;text-align: center; border-bottom: 1px solid black; height: 28px;"
															class="Full warp2 rowsInput2 hide focusBg"></divModel>
										<span class="___absolute t0 right0">mm*</span>
									</div>
									<div v-if="!data.valueData.Judge" class="inputBlock ___absolute Full" style="width: 82px;left:210px;">
										<divModel v-model="data.valueData.irradiationField2"
