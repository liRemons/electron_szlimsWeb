    ...
    <div :class="{ _normalHeight_: true }" class="___relative mt20">
      ...
      <table class="myTable">
        ...
        <tr class="tl">
          ...
          >
            <span
              >在X射线管出线口放1.5mm铜板，照射野设为最大，影像接收器距焦点最近（影像接收器位于床上时则调节至<br />床面上方30cm），探测器紧贴在影像接收器入射面，在自动亮度控制条件下测量空气比释动能率。如无自动亮度<br />控制功能，则在70kV，1mA条件下测量。如果设备有滤线栅，则检测应该应除以2。计算公式：检测结果=A×f×k，<br />有滤线栅时A=0.5，无滤线栅时A=1</span
            >
          </td>
        </tr>
        <tr>
