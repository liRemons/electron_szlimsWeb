<template>
	<div>
		<div style="border: 1px solid black; line-height: 32px; text-align: left; padding-left: 10px; border-top: none;">
			检测项目：{{data.valueData.testProjectChineseName}}{{data.valueData.detectionLimitPieces}} &nbsp;&nbsp;&nbsp;&nbsp; 检测依据:{{data.valueData.sysStandardNum}}
		</div>
		<table class="myTable">
			<tr class="delLine">
				<td style="width: 150px;">
					样品编号
					<div>
						<div title="复制该检测项目下所有样品" class="myBtn" style="margin-bottom: 2px; margin-left: 30px;"
						...
						<div class="___relative">
							<div title="粘贴样品" class="___absolute myBtn" style="top: -30px; left: 90px;"
			...
			<tr v-for="(item, index) in data.valueData.point" :key="item.pointId">
				<td @click="generateSampleNum(data.valueData.point)">{{item.sampleNum + '' + item.sampleNumIndex}}</td>
