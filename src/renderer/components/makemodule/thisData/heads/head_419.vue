      ...
      <div class="head_1_row_2 ___table">
        ...
        <div class="head_1_row2_val3">
          <div class="head_1_bottomLine">
            ...
            <divModel type="text" class="head_1_smollInput ___smollInput inputBlock" v-model="data.valueData.nominalCapacity"></divModel>kV&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;<divModel type="text" class="inputBlock head_1_smollInput ___smollInput" v-model="data.valueData.nominalCapacity1"></divModel>mA
          </div>
          <div>
            <divModel class="head_1_smollInput ___smollInput inputBlock" v-model="data.valueData.temperature"></divModel>℃&nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;<divModel class="head_1_smollInput ___smollInput inputBlock" v-model="data.valueData.humidity"></divModel>
          </div>
        </div>
      </div>
      <div class="head_1_row_1">
