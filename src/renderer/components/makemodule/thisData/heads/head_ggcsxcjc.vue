    ...
    <div class="head_1_tableBox ___relative">
      <div class="___relative borderBottom">
        <div class="block ___relative" style="width: 350px;">
          ...
          <divModel
            ...
            style="width: 260px;"
            class="head_1_model moduleInput Full hide focusBg"
          ></divModel>
        </div>
        ...
        <div class="block Full" style="width: 205px; left: 895px;">
          ...
          <divModel
            v-model="data.valueData.monitorType"
            style="width: 115px; border-right: none;"
            :Pulldown="['状态检测', '验收检测']"
            class="head_1_model moduleInput Full hide focusBg"
          ></divModel>
        </div>
      ...
      <div class="___relative borderBottom">
        <div class="block ___relative" style="width: 1100px;">
          ...
          <divModel
            v-model="data.valueData.PlaceClassification"
            style="
              width: 1000px;
              text-align: left;
              padding-left: 10px;
      ...
      <div class="___relative borderBottom">
        <div class="block ___relative" style="width: 1100px;">
          <div
            class="boxs block head_1_title"
            style="width: 90px; line-height: 64px;"
          >
            <span>检测依据</span>
          </div>
          <divModel
            v-model="data.valueData.standard"
            style="width: 1000px; padding-left: 10px; right: 0;"
            class="rowsInput Full hide focusBg"
          ></divModel>
        </div>
      </div>
      <div class="___relative">
        <div class="___relative borderBottom" style="width: 985px;">
          <div class="block ___relative" style="width: 175px;">
            ...
            <divModel
              v-model="data.valueData.DetectionNumber"
              style="width: 84px;"
              class="head_1_model moduleInput Full hide focusBg"
            ></divModel>
          </div>
          <div class="block Full" style="width: 350px; left: 175px;">
            ...
            <divModel
              v-model="data.valueData.objectWork"
              style="width: 275px;"
              class="head_1_model moduleInput Full hide focusBg"
            ></divModel>
          </div>
          <div class="block Full" style="width: 460px; left: 525px;">
            ...
            <div class="Full borderRight" style="left: 85px; width: 375px;">
              <span class="___relative" style="margin-left: 10px; top: -3px;"
                >温度</span
              >
              <divModel
                v-model="data.valueData.temperature1"
                style="width: 30px; height: 25px;"
                class="moduleInput hide borderBottom block focusBg"
              ></divModel>
              <span class="___relative" style="top: -3px;">℃；&nbsp;湿度</span>
              <divModel
                v-model="data.valueData.humidity1"
                style="width: 30px; height: 25px;"
                class="moduleInput hide borderBottom block focusBg"
              ></divModel>
              <span class="___relative" style="top: -3px;">%(RH）；大气压</span>
              <divModel
                v-model="data.valueData.pressure"
                style="width: 30px; height: 25px;"
                class="moduleInput hide borderBottom block focusBg"
              ></divModel>
        ...
        <div class="___relative" style="width: 985px;">
          <div class="block ___relative" style="width: 175px;">
            ...
            <div
              @click="show(0)"
              style="width: 84px;"
              class="head_1_model Full"
            >
              <div class="tc">{{ data.valueData.SituationPlace }}</div>
              <div
                v-if="placeJudge"
                style="width: 84px; top: 32px;"
                class="tc instrumentSelcet2"
              >
                <div
                  v-for="(item, index) in optArr1"
                  @click.stop="statr(index, 0)"
                >
                  {{ item }}
                </div>
              </div>
          ...
          <div class="block Full" style="width: 175px; left: 175px;">
            ...
            >
              ...
              <div
                v-if="windowJudge"
                style="width: 89px; top: 32px;"
                class="tc instrumentSelcet2"
              >
                <div
                  v-for="(item, index) in optArr2"
                  @click.stop="statr(index, 1)"
                >
                  {{ item }}
                </div>
              </div>
          ...
          <div class="block Full" style="width: 175px; left: 350px;">
            ...
            >
              ...
              <div
                v-if="aerationJudge"
                style="width: 95px; top: 32px;"
                class="tc instrumentSelcet2"
              >
                <div
                  v-for="(item, index) in optArr3"
                  @click.stop="statr(index, 2)"
                >
                  {{ item }}
                </div>
              </div>
          ...
          <div class="block Full" style="width: 165px; left: 525px;">
            ...
            >
              ...
              <div
                v-if="lightingJudge"
                style="width: 80px; top: 32px;"
                class="tc instrumentSelcet2"
              >
                <div
                  v-for="(item, index) in optArr4"
                  @click.stop="statr(index, 3)"
                >
                  {{ item }}
                </div>
              </div>
          ...
          <div class="block Full" style="width: 161px; left: 825px;">
            ...
            >
              ...
              <div
                v-if="LayoutJudge"
                style="width: 75px; top: 32px;"
                class="tc instrumentSelcet2"
              >
                <div
                  v-for="(item, index) in optArr5"
                  @click.stop="statr(index, 4)"
                >
                  {{ item }}
                </div>
              </div>
        ...
        <div class="Layout Full">
          ...
          <div class="___absolute" style="top: 4px; left: 30px;">
            <img
              v-if="data.valueData.DetectionPoints == '中央布点'"
              src="../../../../assets/icon/Layout1.png"
              height="55"
              width="80"
            />
            <img
              v-if="data.valueData.DetectionPoints == '对称布点'"
              src="../../../../assets/icon/Layout2.png"
              height="55"
              width="80"
            />
            <img
              v-if="data.valueData.DetectionPoints == '对角线布点'"
              src="../../../../assets/icon/Layout3.png"
              height="55"
              width="80"
            />
            <img
              v-if="data.valueData.DetectionPoints == '梅花布点'"
              src="../../../../assets/icon/Layout4.png"
              height="55"
              width="80"
            />
            <img
              v-if="data.valueData.DetectionPoints == '无'"
              src="../../../../assets/icon/Layout5.png"
              height="55"
              width="80"
            />
          </div>
