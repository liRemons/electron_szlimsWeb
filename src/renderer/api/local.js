...
//审核
export function winUpdateTaskState(taskIds, pass, checkStaffId, isDetect = false, reason) {
  return service({
...
export function getStaffImg(id) {
  return service({
    ...
    transformResponse: function (data) {
      return 'data:image/png;base64,' + btoa(new Uint8Array(data).reduce((data, byte) => data + String.fromCharCode(byte), ''));
    },
    data: {
      id
    }
